...
public class DecoderFactory
{
    ...
    public static boolean isTypedObject(Object encodedObject)
    {
        ...
        if (encodedObject instanceof ActionscriptObject)
        {
            typed = TypeMarshallingContext.getType((ActionscriptObject)encodedObject) != null;
        }
    ...
    public static void invalidType(Object object, Class desiredClass)
    {
        ...
        else if (object instanceof ActionscriptObject)
        {
        	ActionscriptObject aso = (ActionscriptObject)object;
