...
{
	protected MapProxy mapProxy = new MapProxy();
    ...
    public void writeObject(Object o) throws IOException
    {
        ...
        else
        {
            ...
            if (context.legacyMap && o instanceof Map && !(o instanceof ActionscriptObject))
            {
     ...
     * @exclude
     */
    protected void writeMapObject(Object o) throws IOException
    {
    	out.write(kObjectType);
        if (!byReference(o))
        {
            if (!mapProxy.isExternalizable(o))
            {
            	writeMapPropertyProxy_NotExternalizable(mapProxy, o);
            }
            else
            {
            	writePropertyProxy(mapProxy, o);
            }
        }
    }
     ...
     * @exclude
     */
    protected void writeMapPropertyProxy_NotExternalizable(MapProxy proxy, Object instance) throws IOException
    {
    	List propertyNames = proxy.getPropertyNames(instance);
        TraitsInfo ti = new TraitsInfo(proxy.getAlias(instance), proxy.isDynamic(), false, propertyNames);
    ...
    protected void writeCustomObject(Object o) throws IOException
    {
        ...
        if (o instanceof PropertyProxy)
        {
            ...
            else if (context.legacyMap && o instanceof Map && !(o instanceof ActionscriptObject))
            {
                writeMapAsECMAArray((Map)o);
                return;
            }
